...
class AddFrame extends JFrame
{
	...
	AddFrame()
	{
		...
		ActionListener a2 = (ae) ->
		{
			...
			{
				JOptionPane.showMessageDialog(this,"Rollno and Marks should only contain integer values not Alphabets, not spaces, not any special character");
		...
		setTitle("Student Management System: AddStudent");
		setSize(600, 400);
